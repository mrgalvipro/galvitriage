...
-- Authentication stores only approved operator metadata, public device credentials,
-- one-time enrollment/challenge hashes, and opaque session hashes.
...
VALUES ('0006', 'day8_operator_device_auth', 'qa', 'day8-operator-device-auth-v2');
