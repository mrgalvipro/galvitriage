...
-- Runs after 0001 foundation and 0002 Day 2 identity/continuity.
-- Never rewrite either prior migration.
...
VALUES
  ('0003', 'day3_evidence_versioning_v1', 'qa',
   'gv1-0003-day3-evidence-versioning', CURRENT_TIMESTAMP);
