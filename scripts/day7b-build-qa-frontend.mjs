...
removeEmbeddedAdapter(LEGACY_SIGNATURE);removeEmbeddedAdapter('Day 7D progressive customer-intelligence browser adapter.');removeEmbeddedAdapter(AUTHORITATIVE_SIGNATURE);removeEmbeddedAdapter(DAY1_CUSTOMER_SIGNATURE);removeEmbeddedAdapter(DAY1_HUMAN_SIGNATURE);removeEmbeddedAdapter(DAY6_PIN_SIGNATURE);
