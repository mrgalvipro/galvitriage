...
html = html.replace('</head>', `  <meta name="galvicare-environment" content="qa" />\n  <meta name="galvicare-qa-frontend" content="day7c-qa-browser-v1" />\n</head>`);

for (const required of [QA_WORKER, QA_CUSTOMER_URL, TEST_STRIPE_MARKER, QA_GA4, QA_CLARITY, QA_CALENDLY]) {
...
console.log(`PASS — ${OUT} generated as isolated Day 7C QA browser/customer E2E frontend.`);
