...
for (const required of [QA_WORKER, QA_CUSTOMER_URL, TEST_STRIPE_MARKER, QA_GA4, QA_CLARITY, QA_CALENDLY, 'galvisight-followup-questions', 'galvipath-followup-questions', 'evidence_version_bumped']) {
...
console.log(`PASS — ${OUT} generated as isolated Day 7D progressive-intelligence QA browser/customer E2E frontend.`);
